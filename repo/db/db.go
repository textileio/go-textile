...
func initDatabaseTables(db *sql.DB, password string) error {
	...
	create table photos (cid text primary key not null, lastCid text, name text, ext text, created integer, added integer, latitude real, longitude real, source integer);
