...
func (ThreadData_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_thread_blocks_6b159d9cacea980e, []int{6, 0}
}
...
func (*ThreadBlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_blocks_6b159d9cacea980e, []int{0}
}
...
type SignedThreadBlock struct {
	...
	AuthorSig            []byte   `protobuf:"bytes,3,opt,name=authorSig,proto3" json:"authorSig,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*SignedThreadBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_blocks_6b159d9cacea980e, []int{1}
}
...
func (m *SignedThreadBlock) GetAuthorSig() []byte {
	if m != nil {
		return m.AuthorSig
	}
	return nil
...
func (*ThreadInvite) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_blocks_6b159d9cacea980e, []int{2}
}
...
func (*ThreadExternalInvite) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_blocks_6b159d9cacea980e, []int{3}
}
...
func (*ThreadJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_blocks_6b159d9cacea980e, []int{4}
}
...
func (*ThreadLeave) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_blocks_6b159d9cacea980e, []int{5}
}
...
func (*ThreadData) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_blocks_6b159d9cacea980e, []int{6}
}
...
func init() { proto.RegisterFile("thread_blocks.proto", fileDescriptor_thread_blocks_6b159d9cacea980e) }

var fileDescriptor_thread_blocks_6b159d9cacea980e = []byte{
	// 448 bytes of a gzipped FileDescriptorProto
	,
}
