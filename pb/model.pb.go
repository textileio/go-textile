...
func (Thread_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{5, 0}
}
...
func (Thread_Sharing) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{5, 1}
}
...
func (Thread_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{5, 2}
}

type Thread2_Roles_Role int32

const (
	Thread2_Roles_NO_ACCESS Thread2_Roles_Role = 0
	Thread2_Roles_READ      Thread2_Roles_Role = 1
	Thread2_Roles_ANNOTATE  Thread2_Roles_Role = 2
	Thread2_Roles_WRITE     Thread2_Roles_Role = 3
)

var Thread2_Roles_Role_name = map[int32]string{
	0: "NO_ACCESS",
	1: "READ",
	2: "ANNOTATE",
	3: "WRITE",
}
var Thread2_Roles_Role_value = map[string]int32{
	"NO_ACCESS": 0,
	"READ":      1,
	"ANNOTATE":  2,
	"WRITE":     3,
...
func (x Thread2_Roles_Role) String() string {
	return proto.EnumName(Thread2_Roles_Role_name, int32(x))
}
func (Thread2_Roles_Role) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{7, 0, 0}
}
...
func (Block_BlockType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{10, 0}
}
...
func (Block_BlockStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{10, 1}
}
...
func (Notification_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{18, 0}
}
...
func (CafeRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{23, 0}
}
...
func (CafeRequest_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{23, 1}
}
...
func (CafeHTTPRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{26, 0}
}
...
func (*Peer) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{0}
}
...
func (*PeerList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{1}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{2}
}
...
func (*Contact) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{3}
}
...
func (*ContactList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{4}
}
...
func (*Thread) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{5}
}
...
func (*ThreadList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{6}
}
...
func (*Thread2) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{7}
}
...
func (dst *Thread2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Thread2.Merge(dst, src)
}
...
func (m *Thread2) GetSchema() string {
	if m != nil {
		return m.Schema
	}
	return ""
...
func (m *Thread2) GetIntent() string {
	if m != nil {
		return m.Intent
	}
	return ""
...
func (m *Thread2) GetHeads() string {
	if m != nil {
		return m.Heads
	}
	return ""
...
func (m *Thread2) GetHeadBlocks() []*Block {
	if m != nil {
		return m.HeadBlocks
	}
	return nil
...
func (m *Thread2) GetSchemaNode() *Node {
	if m != nil {
		return m.SchemaNode
	}
	return nil
...
func (m *Thread2) GetBlockCount() int32 {
	if m != nil {
		return m.BlockCount
	}
	return 0
...
func (m *Thread2) GetPeerCount() int32 {
	if m != nil {
		return m.PeerCount
	}
	return 0
...
type Thread2_Roles struct {
	Default              Thread2_Roles_Role            `protobuf:"varint,1,opt,name=default,proto3,enum=Thread2_Roles_Role" json:"default,omitempty"`
	Accounts             map[string]Thread2_Roles_Role `protobuf:"bytes,2,rep,name=accounts,proto3" json:"accounts,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=Thread2_Roles_Role"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}

func (m *Thread2_Roles) Reset()         { *m = Thread2_Roles{} }
func (m *Thread2_Roles) String() string { return proto.CompactTextString(m) }
func (*Thread2_Roles) ProtoMessage()    {}
func (*Thread2_Roles) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{7, 0}
}
func (m *Thread2_Roles) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Thread2_Roles.Unmarshal(m, b)
}
func (m *Thread2_Roles) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Thread2_Roles.Marshal(b, m, deterministic)
}
func (dst *Thread2_Roles) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Thread2_Roles.Merge(dst, src)
}
func (m *Thread2_Roles) XXX_Size() int {
	return xxx_messageInfo_Thread2_Roles.Size(m)
}
func (m *Thread2_Roles) XXX_DiscardUnknown() {
	xxx_messageInfo_Thread2_Roles.DiscardUnknown(m)
}

var xxx_messageInfo_Thread2_Roles proto.InternalMessageInfo

func (m *Thread2_Roles) GetDefault() Thread2_Roles_Role {
	if m != nil {
		return m.Default
	}
	return Thread2_Roles_NO_ACCESS
}

func (m *Thread2_Roles) GetAccounts() map[string]Thread2_Roles_Role {
	if m != nil {
		return m.Accounts
	}
	return nil
...
type Thread2List struct {
	Items                []*Thread2 `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*Thread2List) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{8}
}
...
func (dst *Thread2List) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Thread2List.Merge(dst, src)
}
...
func (m *Thread2List) GetItems() []*Thread2 {
	if m != nil {
		return m.Items
	}
	return nil
...
func (*ThreadPeer) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{9}
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{10}
}
...
func (*BlockList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{11}
}
...
func (*BlockMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{12}
}
...
func (*Invite) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{13}
}
...
func (*InviteList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{14}
}
...
func (*FileIndex) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{15}
}
...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{16}
}
...
func (*Link) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{17}
}
...
func (*Notification) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{18}
}
...
func (*NotificationList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{19}
}
...
func (*Cafe) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{20}
}
...
func (*CafeSession) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{21}
}
...
func (*CafeSessionList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{22}
}
...
func (*CafeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{23}
}
...
func (*CafeRequestList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{24}
}
...
func (*CafeSyncGroupStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{25}
}
...
func (*CafeHTTPRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{26}
}
...
func (*CafeMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{27}
}
...
func (*CafeClientNonce) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{28}
}
...
func (*CafeClient) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{29}
}
...
func (*CafeClientList) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{30}
}
...
func (*CafeToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{31}
}
...
func (*CafeClientThread) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{32}
}
...
func (*CafeClientMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_764cb88bf658f828, []int{33}
}
...
func init() {
	...
	proto.RegisterType((*Thread2_Roles)(nil), "Thread2.Roles")
	proto.RegisterMapType((map[string]Thread2_Roles_Role)(nil), "Thread2.Roles.AccountsEntry")
	...
	proto.RegisterEnum("Thread2_Roles_Role", Thread2_Roles_Role_name, Thread2_Roles_Role_value)
...
func init() { proto.RegisterFile("model.proto", fileDescriptor_model_764cb88bf658f828) }

var fileDescriptor_model_764cb88bf658f828 = []byte{
	...
	,
}
