...
type CafeThread_Type int32

const (
	CafeThread_Private  CafeThread_Type = 0
	CafeThread_ReadOnly CafeThread_Type = 1
	CafeThread_Public   CafeThread_Type = 2
	CafeThread_Open     CafeThread_Type = 3
)

var CafeThread_Type_name = map[int32]string{
	0: "Private",
	1: "ReadOnly",
	2: "Public",
	3: "Open",
}
var CafeThread_Type_value = map[string]int32{
	"Private":  0,
	"ReadOnly": 1,
	"Public":   2,
	"Open":     3,
...
func (x CafeThread_Type) String() string {
	return proto.EnumName(CafeThread_Type_name, int32(x))
}
func (CafeThread_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{14, 0}
}

// Sharing controls if (Y/N) a thread can be shared
type CafeThread_Sharing int32

const (
	CafeThread_NotShared  CafeThread_Sharing = 0
	CafeThread_InviteOnly CafeThread_Sharing = 1
	CafeThread_Shared     CafeThread_Sharing = 2
)

var CafeThread_Sharing_name = map[int32]string{
	0: "NotShared",
	1: "InviteOnly",
	2: "Shared",
}
var CafeThread_Sharing_value = map[string]int32{
	"NotShared":  0,
	"InviteOnly": 1,
	"Shared":     2,
}

func (x CafeThread_Sharing) String() string {
	return proto.EnumName(CafeThread_Sharing_name, int32(x))
}
func (CafeThread_Sharing) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{14, 1}
}

// State indicates the loading state
type CafeThread_State int32

const (
	CafeThread_LoadingBehind CafeThread_State = 0
	CafeThread_Loaded        CafeThread_State = 1
	CafeThread_LoadingAhead  CafeThread_State = 2
)

var CafeThread_State_name = map[int32]string{
	0: "LoadingBehind",
	1: "Loaded",
	2: "LoadingAhead",
}
var CafeThread_State_value = map[string]int32{
	"LoadingBehind": 0,
	"Loaded":        1,
	"LoadingAhead":  2,
}

func (x CafeThread_State) String() string {
	return proto.EnumName(CafeThread_State_name, int32(x))
}
func (CafeThread_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{14, 2}
}
...
func (*CafeChallenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{0}
}
...
func (*CafeNonce) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{1}
}
...
func (*CafeRegistration) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{2}
}
...
func (*CafeSession) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{3}
}
...
func (*CafeSessions) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{4}
}
...
func (*CafeRefreshSession) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{5}
}
...
func (*CafePublishContact) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{6}
}
...
func (*CafePublishContactAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{7}
}
...
func (*CafeContactQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{8}
}
...
func (*CafeContactQueryResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{9}
}
...
func (*CafeStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{10}
}
...
func (*CafeObjectList) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{11}
}
...
func (*CafeObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{12}
}
...
func (*CafeStoreThread) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{13}
}
...
type CafeThread struct {
	...
	Type                 CafeThread_Type    `protobuf:"varint,6,opt,name=type,proto3,enum=CafeThread_Type" json:"type,omitempty"`
	State                CafeThread_State   `protobuf:"varint,7,opt,name=state,proto3,enum=CafeThread_State" json:"state,omitempty"`
	Head                 string             `protobuf:"bytes,8,opt,name=head,proto3" json:"head,omitempty"`
	Sharing              CafeThread_Sharing `protobuf:"varint,9,opt,name=sharing,proto3,enum=CafeThread_Sharing" json:"sharing,omitempty"`
...
func (*CafeThread) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{14}
}
...
func (m *CafeThread) GetType() CafeThread_Type {
	if m != nil {
		return m.Type
	}
	return CafeThread_Private
}

func (m *CafeThread) GetState() CafeThread_State {
	if m != nil {
		return m.State
	}
	return CafeThread_LoadingBehind
}
...
func (m *CafeThread) GetSharing() CafeThread_Sharing {
	if m != nil {
		return m.Sharing
	}
	return CafeThread_NotShared
}

func (m *CafeThread) GetMembers() []string {
	if m != nil {
		return m.Members
	}
	return nil
...
func (*CafeClientThread) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{15}
}
...
func (*CafeStored) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{16}
}
...
func (*CafeDeliverMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{17}
}
...
func (*CafeCheckMessages) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{18}
}
...
func (*CafeMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{19}
}
...
func (*CafeMessages) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{20}
}
...
func (*CafeDeleteMessages) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{21}
}
...
func (*CafeDeleteMessagesAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_cafe_c27efac5095dc10e, []int{22}
}
...
func init() {
	...
	proto.RegisterEnum("CafeThread_Type", CafeThread_Type_name, CafeThread_Type_value)
	proto.RegisterEnum("CafeThread_Sharing", CafeThread_Sharing_name, CafeThread_Sharing_value)
	proto.RegisterEnum("CafeThread_State", CafeThread_State_name, CafeThread_State_value)
}

func init() { proto.RegisterFile("cafe.proto", fileDescriptor_cafe_c27efac5095dc10e) }

var fileDescriptor_cafe_c27efac5095dc10e = []byte{
	// 975 bytes of a gzipped FileDescriptorProto
	,
}
