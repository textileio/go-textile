...
func (ThreadBlock_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{1, 0}
}
...
func (*ThreadEnvelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{0}
}
...
func (*ThreadBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{1}
}
...
func (*ThreadBlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{2}
}
...
func (*ThreadInvite) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{3}
}
...
func (*ThreadIgnore) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{4}
}
...
func (*ThreadFlag) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{5}
}
...
type ThreadJoin struct {
	...
	Inboxes              []*Cafe  `protobuf:"bytes,3,rep,name=inboxes,proto3" json:"inboxes,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*ThreadJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{6}
}
...
func (m *ThreadJoin) GetInboxes() []*Cafe {
	if m != nil {
		return m.Inboxes
	}
	return nil
...
type ThreadAnnounce struct {
	...
	Inboxes              []*Cafe  `protobuf:"bytes,2,rep,name=inboxes,proto3" json:"inboxes,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*ThreadAnnounce) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{7}
}
...
func (m *ThreadAnnounce) GetInboxes() []*Cafe {
	if m != nil {
		return m.Inboxes
	}
	return nil
...
func (*ThreadMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{8}
}
...
func (*ThreadFiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{9}
}
...
func (*ThreadComment) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{10}
}
...
func (*ThreadLike) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_1aa6a6dcd5dd487a, []int{11}
}
...
func init() { proto.RegisterFile("thread.proto", fileDescriptor_thread_1aa6a6dcd5dd487a) }

var fileDescriptor_thread_1aa6a6dcd5dd487a = []byte{
	// 663 bytes of a gzipped FileDescriptorProto
	,
}
