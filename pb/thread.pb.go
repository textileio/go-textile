...
func (ThreadBlock_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{1, 0}
}
...
func (ThreadData_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{7, 0}
}
...
func (ThreadAnnotation_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{8, 0}
}
...
func (*ThreadEnvelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{0}
}
...
func (*ThreadBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{1}
}
...
func (*ThreadBlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{2}
}
...
func (*ThreadIgnore) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{3}
}
...
func (*ThreadInvite) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{4}
}
...
func (*ThreadJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{5}
}
...
func (*ThreadAnnounce) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{6}
}
...
func (*ThreadData) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{7}
}
...
func (*ThreadAnnotation) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_ab2313fd6f69a371, []int{8}
}
...
func init() { proto.RegisterFile("thread.proto", fileDescriptor_thread_ab2313fd6f69a371) }

var fileDescriptor_thread_ab2313fd6f69a371 = []byte{
	// 575 bytes of a gzipped FileDescriptorProto
	,
}
