...
func (ThreadBlock_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{1, 0}
}
...
func (*ThreadEnvelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{0}
}
...
func (*ThreadBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{1}
}
...
func (*ThreadBlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{2}
}
...
func (*ThreadInvite) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{3}
}
...
func (*ThreadIgnore) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{4}
}
...
func (*ThreadFlag) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{5}
}
...
func (*ThreadJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{6}
}
...
func (*ThreadAnnounce) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{7}
}
...
func (*ThreadMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{8}
}
...
func (*ThreadFiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{9}
}
...
func (*ThreadComment) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{10}
}
...
func (*ThreadLike) Descriptor() ([]byte, []int) {
	return fileDescriptor_thread_263a9e88e5a36639, []int{11}
}
...
func init() { proto.RegisterFile("thread.proto", fileDescriptor_thread_263a9e88e5a36639) }

var fileDescriptor_thread_263a9e88e5a36639 = []byte{
	// 636 bytes of a gzipped FileDescriptorProto
	,
}
