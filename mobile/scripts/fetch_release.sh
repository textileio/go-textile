...
# fetch iOS framework
mkdir -p ${IOS_DIR}
wget https://github.com/textileio/textile-go/releases/download/v0.1.4/textile-go_v0.1.4_ios-framework.tar.gz
...
mkdir -p ${ANDROID_DIR}
wget https://github.com/textileio/textile-go/releases/download/v0.1.4/textile-go_v0.1.4_android_aar.tar.gz
