...
// 2019-03-22 17:34:20.073321 -0700 PDT m=+0.278304365
                ...
                "parameters": [
                    {
                        ...
                        "description": "local: Whether to only search local contacts, limit: Stops searching after limit results are found, wait: Stops searching after 'wait' seconds have elapsed (max 30s), username: search by username string, address: search by account address string, events: Whether to emit Server-Sent Events (SSEvent) or plain JSON",
                        "name": "X-Textile-Opts",
                        "in": "header"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "description": "thread: Thread ID (can also use 'default'), address: Account Address (omit to create an external invite), wait: Stops searching after 'wait' seconds have elapsed (max 30s)",
                        "name": "X-Textile-Opts",
                        "in": "header"
                    }
                ],
